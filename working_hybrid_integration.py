...
# Audio settings (using the working configuration)
CHUNK = 1024
...
class WorkingHybridIntegration:
    def __init__(self):
        self.bot_id = None
    ...
    def setup_microphone(self):
        """Setup microphone for audio input using working configuration"""
        try:
            self.stream = self.audio.open(
                ...
                rate=RATE,
                input=True,
                input_device_index=0,  # Use MacBook Pro Microphone
    ...
    def run(self):
        ...
        print("🚀 Starting Working Hybrid Integration")
        ...
        print("🎯 Working hybrid integration running!")
...
def main():
    integration = WorkingHybridIntegration()
    integration.run()
